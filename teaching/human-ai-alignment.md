...
<figure style="margin:1.5rem 0;">
  <img src="../../assets/images/All%20of%20Psychology.png" alt="A whiteboard-style image showing psychology as a broad conceptual system where lived experience becomes compressed into usable meaning and adaptive action." style="display:block; width:100%; height:auto; border:1px solid #ddd; border-radius:10px; background:#fff;">
...
<figure style="margin:1.5rem 0;">
  <img src="../../assets/images/SImpler%20psychology.png" alt="A simpler whiteboard-style image showing complex writing becoming simpler forms, based only on the raw prompt." style="display:block; width:100%; height:auto; border:1px solid #ddd; border-radius:10px; background:#fff;">
